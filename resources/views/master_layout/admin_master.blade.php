            ...
            <div id="inner-container">
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                            <li>
                                <a href="{{route('admin.dashboard')}}" class="active"><i class="fa fa-fire"></i>Dashboard</a>
                            </li>
                            <!-- <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('admin.AllEmployer')}}"><i class="fa fa-file-text"></i>All Employer</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.jobslots')}}"><i class="fa fa-exclamation-triangle"></i>Job Slots</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{route('admin.allteam_member')}}"><i class="fa fa-flask"></i>Team Members & Admin Users</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.employer_interview_tracking')}}"><i class="fa fa-flask"></i>Employer Interview Tracking</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('admin.AllCandidate')}}"><i class="fa fa-file-text"></i>All Candidates</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.CandidateAssesment')}}"><i class="fa fa-exclamation-triangle"></i>Candidate Assesment</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.candidate_interview')}}"><i class="fa fa-magic"></i>Candidate Interview Tracking</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('admin.AssesmentCreation')}}"><i class="fa fa-file-text"></i>Assesment Creation</a>
                                    </li>
                ...
                <!-- Footer -->
                <footer>
                    <span id="year-copy"></span> &copy; <strong><a href="">Re-Invent Crews</a></strong> - Crafted with <i class="fa fa-heart text-danger"></i> by <strong><a href="" target="">Aligned</a></strong>
                </footer>
                <!-- END Footer -->
            </div>
            <!-- END Inner Container -->
